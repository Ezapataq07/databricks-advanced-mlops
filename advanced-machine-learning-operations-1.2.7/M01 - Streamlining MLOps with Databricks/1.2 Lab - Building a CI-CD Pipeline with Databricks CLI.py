...
def setup_git_repo(config_path="var/git_credentials.cfg"):
    ...
    try:
        ...
        subprocess.run('git config --global user.name "EmanuelZapata"', shell=True, check=True)
        subprocess.run('git config --global user.email "emanuel.zapata@lovelytics.com"', shell=True, check=True)
